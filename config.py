...
class Config:
    ...
    LEDGERLINK_NEO_JSONRPC_HOST = get_envsetting('LEDGERLINK_NEO_JSONRPC_HOST')
    LEDGERLINK_NEO_JSONRPC_PORT = get_envsetting('LEDGERLINK_NEO_JSONRPC_PORT')
    LEDGERLINK_CONTRACT_SCRIPT_HASH = get_envsetting('LEDGERLINK_CONTRACT_SCRIPT_HASH')
